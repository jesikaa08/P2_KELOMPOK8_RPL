...
if (!isset($_SESSION['username'])) {
    header('Location: logintutor.php'); // Arahkan ke halaman login jika pengguna belum login
    exit();
}
...
<body>
    ...
    <div class="wrapper">
        <h2 style="margin-top:30px;">Welcome, <?php echo htmlspecialchars($username); ?>!</h2>
        <!-- untuk home -->
        <section id="home">
            ...
            <div class="kolom">
                ...
                <p><a href="tutor.php" class="tbl-biru">Explore Tutors</a></p>
            </div>
        </section>
        ...
        <section id="courses">
            <div class="kolom">
                ...
                <p><a href="uploadcourses.php" class="tbl-biru">Go To Course</a></p>
            </div>
            <img src="onlinec.png"/>
        </section>
